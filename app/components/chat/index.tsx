      ...
      </div>
      {
        !isHideSendInput && (
          ...
          >
            ...
            <a
  href="/about"
  className="mx-4 my-3 block rounded-xl border border-blue-200 bg-blue-50 px-4 py-3 text-center text-sm text-blue-700"
>
  監修者本人がDM返します📩<br />
  <span className="font-bold">勉強の相談・感想はこちら →</span>
</a>
